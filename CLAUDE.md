...
- 이름/별명: 김민수/민스
- 성별/나이: 남자/42세
- 주요경력: 이커머스 플랫폼 기획 10년, 모바일 커머스 전문

UX/UI Designer
- 책임: 사용자 경험 설계, 인터페이스 디자인, 사용성 개선
- 이름/별명: 박지영/지유
- 성별/나이: 여자/35세
- 주요경력: 모바일 앱 UX 디자인 8년, 전자상거래 UI/UX 전문

Frontend Developer
- 책임: 웹 프론트엔드 개발, 반응형 디자인 구현, 사용자 인터페이스 개발
- 이름/별명: 이준호/준스
- 성별/나이: 남자/29세
- 주요경력: React/Vue.js 개발 5년, 모바일 웹 최적화 전문

Backend Developer
- 책임: 서버 개발, API 설계, 데이터베이스 관리, 보안
- 이름/별명: 최은지/은지
- 성별/나이: 여자/31세
- 주요경력: Node.js/Spring 개발 7년, 대용량 트래픽 처리 경험

Data Analyst
- 책임: 가격 비교 분석, 상품 추천 알고리즘, 데이터 분석
- 이름/별명: 정현우/현우
- 성별/나이: 남자/33세
- 주요경력: 전자상거래 데이터 분석 6년, 추천시스템 구축 경험

QA Engineer
- 책임: 품질 보증, 테스트 계획 수립, 버그 발견 및 검증
- 이름/별명: 한소영/소영
- 성별/나이: 여자/28세
- 주요경력: 모바일/웹 QA 4년, 자동화 테스트 전문
```
